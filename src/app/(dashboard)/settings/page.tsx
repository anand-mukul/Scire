...
export default function SettingsPage() {
    ...
    return (
        <div className="relative min-h-screen w-full bg-background overflow-hidden text-foreground selection:bg-primary/20">
            ...
            <div className="relative z-10 p-6 md:p-8 max-w-4xl mx-auto space-y-10">
                {/* Header */}
                <motion.div
                ...
                >
                    <div className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors cursor-pointer w-fit group" onClick={() => router.back()}>
                ...
                >
                    ...
                    <PremiumCard className="p-0 bg-card overflow-hidden divide-y divide-border/50">
